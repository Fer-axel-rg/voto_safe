//Lista de cédulas
// src/components/voting/BallotCard.tsx
...
export default function BallotCard({ election, status, onClick }: BallotCardProps) {
  const getStatusBadge = () => {
    const badges = {
      PENDIENTE: { label: "POR COMENZAR", color: "bg-red-500" },
      ACTIVA: { label: "ACTIVA", color: "bg-green-500" },
      VOTO: { label: "VOTO", color: "bg-blue-500" },
      NULO: { label: "NULO", color: "bg-gray-500" },
      "NO VOTO": { label: "NO VOTO", color: "bg-orange-500" },
    };
